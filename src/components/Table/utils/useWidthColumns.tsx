...
function parseColWidth(totalWidth: number, width: number | string = '') {
...
export default function useWidthColumns<RecordType>(
  flattenColumns: Column<RecordType>[],
  scrollWidth: number | undefined,
  clientWidth: number,
) {
  return React.useMemo<
    [columns: Columns<RecordType>, realScrollWidth: number | undefined]
  >(() => {
